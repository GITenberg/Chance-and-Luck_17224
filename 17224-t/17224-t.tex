...
%% Lprep/gutcheck: OK                                                    %%
%% Lacheck: OK                                                           %%
%% PDF pages, excl. Gutenberg boilerplate:  155                          %%
%% PDF pages, incl. Gutenberg boilerplate:  164                          %%
%% ToC page numbers: OK                                                  %%
%% Images: None                                                          %%
%% Fonts: OK                                                             %%
%%                                                                       %%
%% Compile History:                                                      %%
%%                                                                       %%
%% Dec 05: rfrank47. Compiled with pdflatex:                             %%
%%         [pdfeTeX, Version 3.141592-1.20a-rc4-2.1 (MiKTeX 2.4)]        %%
%%         pdflatex chance.tex                                           %%
%%         pdflatex chance.tex                                           %%
%%         pdflatex chance.tex                                           %%
%%                                                                       %%
%% Dec 05: jt. Compiled with latex/dvipdfm                               %%
%%         latex 17224-t                                                 %%
%%         latex 17224-t                                                 %%
%%         latex 17224-t                                                 %%
%%         dvipdfm 17224-t                                               %%
